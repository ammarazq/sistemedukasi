      ...
      >
        ...
        <div
          style={{
            ...
            color: feedback?.status === "benar" ? "#2E7D32" : "#D4A017",

            transform:
              feedback?.status === "benar" ? "scale(1.15)" : "scale(1)",

            transition: "all .3s ease",

            textShadow: "0 0 15px rgba(52,152,219,.4)",
          }}
        >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: aktif ? "3px solid #F4A623" : "2px solid #E5E7EB",
